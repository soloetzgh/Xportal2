...
public class PlatformStatisticsDao {

    private static final GeneralUtility utility = new GeneralUtility();
    private static final Logger log = Logger.getLogger(PlatformStatisticsDao.class.getName());
    ...
    public static void main(String[] args) {
        ...
        new PlatformStatisticsDao().getPlatformStatistics(json);
        System.exit(0);
    }
    ...
    public List<Elevy> getPlatformStatistics(String jsonString) {

        log.info("Platform trx request received >>  " + jsonString);
        Gson j = new Gson();
