 ...
 */
public class MobilemoneyReprocessingProxy extends HttpServlet {
    ...
    private static final Logger log = Logger.getLogger(MobilemoneyReprocessingProxy.class.getName());
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (allowed) {
                ...
                if (apiData.getType_id().contains("[6]")) {
                    ...
                    out.println(new Gson().toJson(channels));
                    channels = null;
                } else if (apiData.getService().equalsIgnoreCase("Mobilemoneyreprocess")) {
                    System.out.println("Mobile Money Proxy started");
                    if (allowUpdate) {
                        List<MobileMoneyReprocess> records = new MobileMoneyReprocessingDao().getUploadedData(new Gson().toJson(apiData));
                ...
                } else if (apiData.getService().equalsIgnoreCase("transqueryAPI")) {

                    if (allowUpdate) {
                        List<MobileMoneyReprocess> records = new MobileMoneyReprocessingDao().callTransqueryApi(new Gson().toJson(apiData));
                ...
                } else if (apiData.getService().equalsIgnoreCase("reprocessingTable")) {

                    if (allowUpdate) {
                        List<MobileMoneyReprocess> records = new MobileMoneyReprocessingDao().callReprocessingTable(new Gson().toJson(apiData));
                ...
                } else if (apiData.getService().equalsIgnoreCase("mobilemoneyreprocesslog")) {
                    System.out.println("Mobile Money Reproces log Proxy started");
                    if (allowUpdate) {
                ...
                } else if (apiData.getService().equalsIgnoreCase("updateMobileMoneyTable")) {
                    System.out.println("Mobile Money update Reproces log Proxy started");
                    if (allowUpdate) {
                        List<MobileMoneyReprocess> records = new MobileMoneyReprocessingDao().callMobileMoneyUpdateTable(new Gson().toJson(apiData));
