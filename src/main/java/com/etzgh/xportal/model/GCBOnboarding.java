...
@XmlRootElement
@Entity
public class GCBOnboarding implements Serializable {
    ...
    public String toString() {
        return "GCBOnboarding{" + "id=" + id + ", card_ACCT=" + card_ACCT + ", branch=" + branch + ", lname=" + lname + ", fname=" + fname + ", mobile=" + mobile + ", coy=" + coy + ", acct_ID=" + acct_ID + ", email=" + email + ", status=" + status + ", city=" + city + ", state=" + state + ", country=" + country + ", secondary=" + secondary + ", status2=" + status2 + ", created=" + created + ", modified=" + modified + ", bankok=" + bankok + ", centralok=" + centralok + ", batchid=" + batchid + '}';
    }
