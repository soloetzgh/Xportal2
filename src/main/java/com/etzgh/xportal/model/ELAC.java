...
@Entity
@XmlRootElement
public class ELAC implements Serializable {
    ...
    public String toString() {
        return "ElacTransaction{" + "unique_transid=" + unique_transid + ", merchant_id=" + merchant_id + ", trans_amount=" + amount + ", trans_date=" + trans_date + ", trans_channel=" + trans_channel + ", trans_status=" + trans_status + ", trans_note=" + trans_note + ", subscriber_id=" + subscriber_id + ", issuer_code=" + issuer_code + ", payment_code=" + payment_code + ", mobile_no=" + mobile_no + '}';
    }
}
