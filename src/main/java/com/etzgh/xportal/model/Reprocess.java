...
public class Reprocess implements Serializable {
    ...
    public String toString() {
        return "Reprocess{" + "id=" + id + ", unique_transid=" + unique_transid + ", amount=" + amount + ", source=" + source + ", dest_account=" + dest_account + ", linetype=" + linetype + ", response_code=" + response_code + ", response_message=" + response_message + ", provider=" + provider + ", transtype=" + transtype + ", otherinfo=" + otherinfo + ", mac=" + mac + ", trans_date=" + trans_date + ", response_date=" + response_date + '}';
    }
