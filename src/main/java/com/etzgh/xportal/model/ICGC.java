...
@Entity
@XmlRootElement
public class ICGC implements Serializable {
    ...
    public String toString() {
        return "ICGC{" + "unique_transid=" + unique_transid + ", transid=" + transid + ", trans_channel=" + trans_channel + ", amount=" + amount + ", trans_note=" + trans_note + ", trans_status=" + trans_status + ", ubscriber_id=" + subscriber_id + ", mobile_=" + mobile_no + ", product=" + product + ", response_date=" + response_date + '}';
    }
